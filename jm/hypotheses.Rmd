...
Ideally then, in place of bytes ratios, it would probably have been good to utilize bytes instead, along with hourly information number of links each inlink page has, in order to give a rough idea of how big the inlink page is, and how likely one might click on our page of interest given a number of other links to click on.  However, we only had access to the hourly bytes observation of the page, which could possibly introduce collinearity between the traffic for the inlink and its bytes size. (Isn't linear regression fun?)
